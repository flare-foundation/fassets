...
export interface AssetManagerInitSettings extends AssetManagerSettings {
    ...
    coreVaultTransferDefaultPenaltyBIPS: BNish;
    ...
    directMintingOthersCanExecuteAfterSeconds: BNish;
...
export async function newAssetManager(
    ...
    await deployAndInitFacet(governanceAddress, assetManager, artifacts.require("DirectMintingSettingsFacet"), ["IDirectMintingSettings"],
        (c) => c.initialize({
            ...
            othersCanExecuteAfterSeconds: assetManagerSettings.directMintingOthersCanExecuteAfterSeconds,
